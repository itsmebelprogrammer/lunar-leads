...
class Job(Base):
    ...
    status: Mapped[str] = mapped_column(Enum("QUEUED","RUNNING","DONE","FAILED","CANCELLED", name="jobstatus", create_type=True), default="QUEUED")
    export_format: Mapped[str] = mapped_column(Enum("CSV","XLSX", name="exportformat", create_type=True), default="CSV")
